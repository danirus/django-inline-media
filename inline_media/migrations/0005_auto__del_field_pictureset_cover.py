...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PictureSet.cover'
        db.delete_column('inline_media_picture_sets', 'cover_id')


    def backwards(self, orm):
        # Adding field 'PictureSet.cover'
        db.add_column('inline_media_picture_sets', 'cover',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inline_media.Picture'], null=True, blank=True),
                      keep_default=False)
