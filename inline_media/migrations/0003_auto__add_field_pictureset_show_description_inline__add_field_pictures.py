...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PictureSet.show_description_inline'
        db.add_column('inline_media_picture_sets', 'show_description_inline',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'PictureSet.show_counter'
        db.add_column('inline_media_picture_sets', 'show_counter',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PictureSet.show_description_inline'
        db.delete_column('inline_media_picture_sets', 'show_description_inline')

        # Deleting field 'PictureSet.show_counter'
        db.delete_column('inline_media_picture_sets', 'show_counter')
